...
export const saveExperiment = async (experimentId, data) => {
...
export const loadExperiment = async (experimentId) => {
    const experimentsPath = getExperimentsPath();
    const filePath = join(experimentsPath, `${experimentId}.json`);
    try {
